...
public class IPiece extends Piece {
    ...
    protected void setElements(Coordonnees coordonnees, Couleur couleur) {
        Coordonnees coo1 = new Coordonnees(coordonnees.getAbscisse(), coordonnees.getOrdonnee() - 2);
        Coordonnees coo2 = new Coordonnees(coordonnees.getAbscisse(), coordonnees.getOrdonnee() - 1);
        Coordonnees coo3 = new Coordonnees(coordonnees.getAbscisse(), coordonnees.getOrdonnee() + 1);
